...
func (x *HelloReply) GetServerTime() int64 {
	if x != nil {
		return x.ServerTime
	}
	return 0
...
const file_proto_hello_proto_rawDesc = "" +
	...
	"serverTime2G\n" +
	"\aGreeter\x12<\n" +
	"\bSayHello\x12\x18.helloworld.HelloRequest\x1a\x16.helloworld.HelloReplyB=Z;example.com/cuit-go-frameworks/grpc-demo/proto;helloworldpbb\x06proto3"
